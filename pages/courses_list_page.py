...
class CoursesListPage(BasePage):
    def __init__(self, page: Page):
        ...
        self.courses_title = page.get_by_test_id('courses-list-toolbar-create-course-button')
        ...
        self.course_delete_menu_button = page.get_by_test_id('course-view-delete-menu-item-icon')
    ...
    def check_visible_course_card(
        ...
        expect(self.course_min_text).to_have_text(f'Min score: {min_score}')
